-- Actualizar los estados de las tareas para que estén en español
UPDATE tareas SET estado = CASE 
  WHEN estado = 'pending' THEN 'pendiente'
  WHEN estado = 'in_progress' THEN 'en_progreso'
  WHEN estado = 'done' THEN 'completada'
  ELSE estado
END WHERE estado IN ('pending', 'in_progress', 'done');
